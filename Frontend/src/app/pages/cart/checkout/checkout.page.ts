...
// prettier-ignore
import { IonButton, IonInput, IonRadioGroup, IonButtons, IonContent, IonHeader, IonIcon, IonItem, IonLabel, IonRadio, IonTitle, IonToolbar, ToastController
...
export class CheckoutPage implements OnInit {
  ...
  async placeOrder() {
    if (this.checkoutForm.valid) {
      ...
      await this.testService.addOrder(orderData);
